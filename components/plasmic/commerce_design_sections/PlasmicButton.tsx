...
import sty from "./PlasmicButton.module.css"; // plasmic-import: PsNMFFNBNRNu/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__ciqtR)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__k5TPc)}
                role={"img"}
              />
            ),
