...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: dk84PwxXBd25/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__t1Me7)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__q1QzC)}
              role={"img"}
            />
          ),
